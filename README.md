...
* **Bag Upgrades:** Drag an empty, larger bag from your inventory onto one of the bot's four bag icons. The bot's bag contents move to the new bag, and the old bag goes into the bot's backpack. The bot needs one free backpack slot.
